...
* **Atmospheric Physics:** The atmospheric correction engine is powered by [<img src="https://img.shields.io/badge/Radiative%20Transfer-Py6S-orange?style=for-the-badge&logo=python&logoColor=white">](https://py6s.readthedocs.io/en/master/), employing a Homogeneous Lambertian + Water Lake ground reflectance model.
